...
class SpecialGarbageRequestScreen extends StatefulWidget {
  const SpecialGarbageRequestScreen({
    Key? key,
  }) : super(key: key);

  @override
  _SpecialGarbageRequestScreenState createState() => _SpecialGarbageRequestScreenState();
}

class _SpecialGarbageRequestScreenState extends State<SpecialGarbageRequestScreen> {
                ...
                Column(
                  children: [
                    CircleAvatar(
                      ...
                      backgroundColor: Colors.green.withOpacity(0.1),
                      child: IconButton(
                        icon: const Icon(Icons.photo_library, color: Colors.green, size: 30),
                        onPressed: () {
                          Navigator.pop(context);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoadingUser || _isLoading
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: _garbageTypes.map((String type) {
                    ...
                    const SizedBox(height: 8),
                    const Text(
                      'Tap on the map to select the exact location for collection',
                      style: TextStyle(
                        color: Colors.grey,
